...
let UsersController = class UsersController {
    ...
    async setupAdmin(id) {
        return this.usersService.setRoles(id, [user_schema_1.UserRole.ADMIN]);
    }
    cleanupFollowingComics(id) {
...
__decorate([
    (0, common_1.Get)('setup-admin/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "setupAdmin", null);
__decorate([
    (0, common_1.Post)(':id/cleanup-following'),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "cleanupFollowingComics", null);
